...
\item Places generating sink which can delay the current task:
	lee-sides, in-between cloudstreets, rainfall, information derived from
...
\item Places generating sink which can delay the current task: lee-sides,
	in-between cloudstreets, information derived from meteorological
	observations (precipitation, wind, reduced cloud ceiling, high cloud
	cover)
\end{itemize}
